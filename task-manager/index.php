...
<div class="task-list">
    ...
    if (isset($_SESSION['done_fail'])) {
        echo $_SESSION['done_fail'];
        unset($_SESSION['done_fail']);
    }
    ?>
    <table class="taskList-table table">
        ...
        <?php
        $sql = "SELECT * FROM tbl_tasks WHERE task_status='Not assigned' OR task_status='Working' ORDER BY task_deadlineDate DESC";
