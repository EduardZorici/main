<?php
$pageLink = "in-queue.php";
$pageName = "Tasks In Queue";
?>
...
<div class="task-list">
    <div class="buttons">
        <a class="addTask-button button" href="<?php echo URL; ?>add-task.php?task_status=<?php echo "Not assigned"; ?>">Add Task</a>
    </div>
...
?>
    <table class="taskList-table table">
        ...
        <?php
$sql = "SELECT * FROM tbl_tasks WHERE task_status='Not assigned' ORDER BY task_deadlineDate DESC";
