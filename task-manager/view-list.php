...
<h2><?php echo $list_name;
?></h2>
<h3><?php echo $list_description;
?></h3>
<br />
<div class="buttons">
    <a class="addTask-button button" href="<?php echo URL; ?>add-task.php?list_id=<?php echo $list_id; ?>">Add Task</a>
    <a class="addList-button button" href="<?php echo URL; ?>update-list.php?list_id=<?php echo $list_id; ?>">Update List</a>
    <a class="delete-button addUser-button button" href="<?php echo URL; ?>delete-list.php?list_id=<?php echo $list_id; ?>">Delete</a>
</div>
<br />
<table class="taskList-table table">
    ...
    <?php
$sql1 = "SELECT * FROM tbl_tasks WHERE list_id=$list_id ORDER BY task_deadlineDate DESC";
