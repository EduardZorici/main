<?php
$pageLink = "ongoing.php";
$pageName = "Ongoing Tasks";
?>
...
<div class="task-list">
    <div class="buttons">
        <a class="addTask-button button" href="<?php echo URL; ?>add-task.php?task_status=<?php echo "Working"; ?>">Add Task</a>
    </div>
...
?>
    <table class="taskList-table table">
        ...
        <?php
$sql = "SELECT * FROM tbl_tasks WHERE task_status='Working' ORDER BY task_deadlineDate DESC";
    ...
    if ( $count_rows > 0 ) {
        ...
        <tr>
            ...
            <td class="actions-td"><?php if ($task_status != 'Done') { ?>
                ...
                <a class="working-button" href="<?php echo URL; ?>view-task.php?task_id=<?php echo $task_id; ?>"><span class="assign-icon sprite-icon"></span><span class="action-button-text">View</span></a>
